...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("ab_krishna_uff")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("Meetup_zone")
                await self.two.join_chat("Meetup_zone")
                await self.two.join_chat("Meetup_zone")
                await self.two.join_chat("Meetup_zone")
                await self.two.join_chat("ab_krishna_uff")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                ...
                await self.three.join_chat("Meetup_zone")
                await self.three.join_chat("Meetup_zone")
                await self.three.join_chat("ab_krishna_uff")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("Meetup_zone")
                await self.four.join_chat("Meetup_zone")
                await self.four.join_chat("Meetup_zone")
                await self.four.join_chat("ab_krishna_uff")
                await self.four.join_chat("Meetup_zone")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("Meetup_zone")
                await self.five.join_chat("ab_krishna_uff")
                await self.five.join_chat("AB_KRISHNA_UFF")
                await self.five.join_chat("Meetup_zone")
                await self.five.join_chat("ab_krishna_uff")
            except:
